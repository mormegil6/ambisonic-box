...
- [docs/IOS-SAFARI.md](docs/IOS-SAFARI.md): Safari and iOS refuse this stream's multichannel Opus entirely, a WASM fallback proven on real hardware instead, and how it is wired into the live player
