...
Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the maintainer at bartlomiej.mroz@pg.edu.pl. All complaints will be reviewed and investigated promptly and fairly, and the privacy and security of the reporter will be respected.

This is a small research project with a single maintainer, so enforcement is necessarily informal: expect a reply within a few days, and expect the maintainer to be the person who reads it. Serious matters involving members of Gdańsk University of Technology may also be raised through the Department of Multimedia Systems.
