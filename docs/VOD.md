...
<div align="center"> <img src="../content/vod/masters/preview/viewer-front-90deg.png" width="45%" alt="The FRONT wall of the 360 test card as a viewer sees it inside the sphere at a 90 degree field of view: the card is flat and undistorted, circles round and lines straight"> <img src="../content/vod/masters/preview/viewer-up-90deg.png" width="45%" alt="The UP wall of the same card seen by a viewer looking straight up: an ordinary ceiling card rather than the smeared blob equirectangular drawing produces at a pole"> </div>
